...
public class AISValidatorWrapper {
                    ...
                    if (issueLocation instanceof AIS) {
                        ...
                        switch (issueType) {
                            case NAME_LOCALE_OCCURRED_TOO_OFTEN:
                                ...
                                this.helper.attachIBasicIS(ais.getNames(), IssueType.NAME_LOCALE_OCCURRED_TOO_OFTEN,
                                        issueParameters);
                            ...
                            case DESCRIPTION_LOCALE_OCCURRED_TOO_OFTEN:
                                ...
                                this.helper.attachIBasicIS(ais.getDescriptions(),
                            ...
                            case SF_IDENTIFIER_OCCURRED_TOO_OFTEN:
                                ...
                                this.helper.attachIIdentifierIS(identifierISs,
                                        IssueType.SF_IDENTIFIER_OCCURRED_TOO_OFTEN, issueParameters);
                                    ...
                                    for (String identifier : issue.getParameters()) {
                                        if (sf.getIdentifier().equals(identifier)
                                            ...
                                            sf.addIssue(new Issue(
                                                    IssueType.SFS_CONTAIN_SAME_RRG_AND_RPS_WITH_SAME_VALUE, sf));
                                        }
                                    }
                                }
                    ...
                    if (issueLocation instanceof AISServiceFeature) {
                        ...
                        switch (issueType) {
                            case NAME_LOCALE_OCCURRED_TOO_OFTEN:
                                ...
                                // Attach names with issue
                                this.helper.attachIBasicIS(sf.getNames(), IssueType.NAME_LOCALE_OCCURRED_TOO_OFTEN,
                                        issueParameters);
                            ...
                            case DESCRIPTION_LOCALE_OCCURRED_TOO_OFTEN:
                                ...
                                // Attach descriptions with issue
                                this.helper.attachIBasicIS(sf.getDescriptions(),
                                        IssueType.DESCRIPTION_LOCALE_OCCURRED_TOO_OFTEN, issueParameters);
                            ...
                            case RRG_IDENTIFIER_OCCURRED_TOO_OFTEN:
                                ...
                                this.helper.attachIIdentifierIS(iISs, IssueType.RRG_IDENTIFIER_OCCURRED_TOO_OFTEN,
                                        issueParameters);
                            ...
                            case RPS_IDENTIFIER_OCCURRED_TOO_OFTEN:
                                ...
                                this.helper.attachIIdentifierIS(identISs, IssueType.RPS_IDENTIFIER_OCCURRED_TOO_OFTEN,
                                        issueParameters);
    ...
    private void addSummaryIssues(IAIS ais) {
        for (IAISServiceFeature sf : ais.getServiceFeatures()) {
            ...
            if (descriptionIssue && !sf.hasIssueType(IssueType.AIS_SF_DESCRIPTION_ISSUES)) {
                sf.addIssue(new Issue(IssueType.AIS_SF_DESCRIPTION_ISSUES, sf));
            }
            if (rrgIssue && !sf.hasIssueType(IssueType.AIS_SF_REQUIRED_RESOURCE_GROUP_ISSUES)) {
                sf.addIssue(new Issue(IssueType.AIS_SF_REQUIRED_RESOURCE_GROUP_ISSUES, sf));
            }
        }
    }
