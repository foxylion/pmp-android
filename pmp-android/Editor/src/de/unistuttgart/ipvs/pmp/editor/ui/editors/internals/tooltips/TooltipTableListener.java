    ...
    public void handleEvent(Event event) {
        switch (event.type) {
            ...
            case SWT.MouseHover: {
                ...
                TableItem item = this.tableViewer.getTable().getItem(new Point(event.x, event.y));
                ...
                if (item != null) {
                    ...
                    if (!((IIssueLocation) item.getData()).getIssues().isEmpty()) {
                        ...
                        TooltipTableLabelListener labelListener = new TooltipTableLabelListener(this.tableViewer);
                        ...
                        Point pt = this.tableViewer.getTable().toDisplay(rect.x, rect.y);
