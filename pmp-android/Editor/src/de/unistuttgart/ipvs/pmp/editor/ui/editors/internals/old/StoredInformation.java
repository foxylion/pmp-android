...
public class StoredInformation {
	...
	public void addName(String locale, String name) {
		if (this.information.containsKey(locale)) {
			this.information.get(locale).setName(name);
		} else {
	...
	public void addDescription(String locale, String desc) {
		if (this.information.containsKey(locale)) {
			this.information.get(locale).setDescription(desc);
		} else {
	...
	public void add(Information i) {
		i.setStore(this);
		this.information.put(i.getLocale(), i);
	}
	...
	public void remove(String locale) {
		this.information.remove(locale);
	}
	...
	public boolean localeExists(String locale) {
		return this.information.containsKey(locale);
	}
	...
	protected void changeLocale(String oldL, String newL) {
		Information i = this.information.remove(oldL);
		this.information.put(newL, i);
	}
