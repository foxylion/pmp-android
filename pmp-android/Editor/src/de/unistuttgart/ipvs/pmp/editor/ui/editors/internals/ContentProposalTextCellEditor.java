...
public class ContentProposalTextCellEditor extends TextCellEditor {
	...
	public ContentProposalTextCellEditor(Composite parent, IContentProposalProvider contentProposalProvider,
	...
	private void enableContentProposal(IContentProposalProvider contentProposalProvider, KeyStroke keyStroke,
		...
		contentProposalAdapter = new ContentProposalAdapter(this.getControl(), new TextContentAdapter(),
