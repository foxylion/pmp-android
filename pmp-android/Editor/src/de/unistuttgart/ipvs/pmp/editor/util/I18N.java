...
public class I18N extends NLS {
    ...
    public static String editor_ais_general_addactivity_tooltip;
    public static String editor_ais_general_addservice;
    public static String editor_ais_general_addservice_tooltip;
    public static String editor_ais_general_appnodemissing_text;
    public static String editor_ais_general_appnodemissing_title;
    public static String editor_ais_general_localization_description;
    ...
    public static String editor_ais_sf_addrg_tooltip;
    public static String editor_ais_sf_addsf;
    public static String editor_ais_sf_addsf_tooltip;
    ...
    public static String editor_ais_sf_names_description;
    ...
    public static String editor_ais_sf_psidentifier_tooltip;
    ...
    public static String editor_ais_sf_requiredps_description;
    ...
    public static String editor_rgis_general_class_tooltip;
    public static String editor_rgis_general_title;
    public static String editor_rgis_general_icon;
    public static String editor_rgis_general_icon_tooltip;
    public static String editor_rgis_general_identifier_tooltip;
    public static String editor_rgis_general_localization_description;
    public static String editor_rgis_general_preferences;
    public static String editor_rgis_general_preferences_description;
    public static String editor_rgis_general_tab;
    public static String editor_rgis_ps_changedescription;
    public static String editor_rgis_ps_identifier_tooltip;
    public static String editor_rgis_ps_localization_description;
    ...
    public static String editor_rgis_ps_validvalues_tooltip;
    public static String general_add;
    public static String general_add_tooltip;
    public static String general_attributes;
    ...
    public static String general_remove_tooltip;
    ...
    public static String editor_rgis_ps_req_tooltip;
    public static String editor_rgis_ps_Requestable;
