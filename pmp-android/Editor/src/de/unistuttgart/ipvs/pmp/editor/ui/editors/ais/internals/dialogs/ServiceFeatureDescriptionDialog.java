...
public class ServiceFeatureDescriptionDialog extends Dialog implements
	...
	protected void configureShell(Shell shell) {
		...
		shell.setText(this.type + " " + this.title);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		// Create message
		String message = this.type + " the " + this.title.toLowerCase()
		...
		this.localeText = new Text(textComposite, SWT.SINGLE | SWT.BORDER);
		this.localeText.addModifyListener(this);
		this.localeText.setLayoutData(new GridData(GridData.GRAB_HORIZONTAL
				| GridData.HORIZONTAL_ALIGN_FILL));

		new AutoCompleteField(this.localeText, new TextContentAdapter(),
				Locale.getISOLanguages());

		new Label(textComposite, SWT.FILL).setText(this.title);
		this.fieldText = new Text(textComposite, SWT.SINGLE | SWT.BORDER);
		this.fieldText.addModifyListener(this);
		this.fieldText.setLayoutData(new GridData(GridData.GRAB_HORIZONTAL
				| GridData.HORIZONTAL_ALIGN_FILL));

		// The error message
		new Label(textComposite, SWT.NULL).setVisible(false);
		this.errorMessageText = new Text(textComposite, SWT.READ_ONLY
				| SWT.WRAP);
		...
		this.errorMessageText.setText("All fields could not be empty");
	...
	public void okPressed() {
		if (this.localeText.getText() != null) {
			this.values.put("locale", this.localeText.getText());
		}

		if (this.fieldText.getText() != null) {
			this.values.put(this.title, this.fieldText.getText());
		}
		close();
	}
	...
	protected void createButtonsForButtonBar(Composite parent) {
		...
		this.localeText.setFocus();

		if (this.locale != null) {
			this.localeText.setText(this.locale);
		}

		if (this.description != null) {
			this.fieldText.setText(this.description);
		}
	}
	...
	public void modifyText(ModifyEvent arg0) {
		if (this.localeText.getText().isEmpty()
				&& this.fieldText.getText().isEmpty()) {
