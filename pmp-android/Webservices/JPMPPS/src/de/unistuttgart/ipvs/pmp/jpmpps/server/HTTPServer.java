            ...
            try {
                ...
                while (!this.connection.isClosed()) {
                    ...
                    for (String headerLine : header) {
                        Matcher matcher = HTTP_PRESET_SET_ID.matcher(headerLine);
                        if (matcher.find()) {
                    ...
                    if (requestedPresetSet == null || requestedPresetSet.equals("")) {
                        ...
                        output.write("Server: JPMPPS\r\n");
                        output.write("Content-Type: text/plain\r\n");
                        output.write("\r\n");
                        output.write("Bad Request (No PresetSet ID defined)");
                    } else {
                        ...
                        if (presetSet == null) {
                            ...
                            output.write("Content-Type: text/plain\r\n");
                            output.write("\r\n");
                            output.write("Bad Request (PresetSet not found)");
                        } else {
                            ...
                            while ((length = is.read(bytes)) != -1) {
                                outputSimple.write(bytes, 0, length);
                            }
                            outputSimple.flush();
                        }
                    }
