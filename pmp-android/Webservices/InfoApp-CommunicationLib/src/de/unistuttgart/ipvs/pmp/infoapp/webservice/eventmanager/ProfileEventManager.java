...
/**
 * Gives access to profile events
 * 
 * @author Patrick Strobel
 * 
 */
public class ProfileEventManager extends EventManager {
    
    /**
     * Creates a new manager for profile events
     * 
     * @param service
     *            Helper class used for communication with the webservice
     */
    public ProfileEventManager(Service service) {
        super(service);
    }
    ...
    public void commitEvents(List<? extends Event> events) throws InternalDatabaseException, InvalidParameterException,
        ...
        commitEvents(events, "upload_profile_events.php");
    }
    ...
    public EventProperty getLastEventProperty() throws InternalDatabaseException, InvalidParameterException,
            IOException {
        return getLastEventProperty("last_profile_event.php");
    }
