...
public class vhikeDialogs extends Activity {
	...
	public RateProfileConfirm getRateProfileConfirmation(Context context, int profileID,
	...
	public AlertDialog getDateTimePicker(final Activity inActivity, final int ID, Calendar cal) {
		...
		dPicker.updateDate(cal.get(Calendar.YEAR), cal.get(Calendar.MONTH),
				...
				.setPositiveButton(mContext.getString(R.string.default_OK),
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								try {
									IDialogFinishedCallBack d =
											(IDialogFinishedCallBack) inActivity;
	...
	public static AlertDialog getConfirmationDialog(final Activity inActivity, int titleId,
			int message,
		...
		if (confirm == null) {
			...
			builder.setTitle(titleId)
					.setPositiveButton(positiveTextId, new DialogInterface.OnClickListener() {
						...
						@Override
						public void onClick(DialogInterface dialog, int which) {
							IConfirmDialogFinishedCallBack callback =
									(IConfirmDialogFinishedCallBack) inActivity;
