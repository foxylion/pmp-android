...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mPaintPageFill = new Paint(Paint.ANTI_ALIAS_FLAG);
        ...
        this.mPaintStroke.setStrokeWidth(a
                .getDimension(R.styleable.CirclePageIndicator_strokeWidth, defaultStrokeWidth));
    ...
    private void updatePageSize() {
        if (this.mViewPager != null) {
            this.mPageSize = (this.mOrientation == HORIZONTAL) ? this.mViewPager.getWidth() : this.mViewPager
                    .getHeight();
        }
    }
    ...
    private int measureLong(int measureSpec) {
        ...
        if ((specMode == MeasureSpec.EXACTLY) || (this.mViewPager == null)) {
            ...
            final int count = this.mViewPager.getAdapter().getCount();
            result = (int) (getPaddingLeft() + getPaddingRight() + (count * 2 * this.mRadius) + (count - 1)
                    * this.mRadius + 1);
