...
public class EnergyImpl extends IEnergy.Stub {
	...
	public int getCurrentLevel() throws RemoteException {
		// Check permission
		psv.validate(EnergyConstants.PS_BATTERY_STATUS, "true");
	...
	public String getCurrentHealth() throws RemoteException {
		// Check permission
		psv.validate(EnergyConstants.PS_BATTERY_HEALTH, "true");
	...
	public boolean getCurrentCharging() throws RemoteException {
		// Check permission
		psv.validate(EnergyConstants.PS_BATTERY_CHARGING_STATUS, "true");
	...
	public String getCurrentChargingSource() throws RemoteException {
		// Check permission
		psv.validate(EnergyConstants.PS_BATTERY_CHARGING_SOURCE, "true");
	...
	public String getCurrentChargingTime() throws RemoteException {
		// Check permission
		psv.validate(EnergyConstants.PS_BATTERY_CHARGING_TIME, "true");
	...
	public String getCurrentTemperature() throws RemoteException {
		// Check permission
		psv.validate(PSBatteryTemperatureEnum.CURRENT);
	...
	public String getLastBootDate() throws RemoteException {
		// Check permission
		psv.validate(PSDeviceDatesEnum.LAST_BOOT);
	...
	public String getLastBootUptimeBattery() throws RemoteException {
		// Check permission
		psv.validate(PSDeviceBatteryChargingUptimeEnum.ALL);
	...
	public String getLastBootRatio() throws RemoteException {
		// Check permission
		psv.validate(EnergyConstants.PS_BATTERY_CHARGING_RATIO, "true");
	...
	public String getLastBootTemperaturePeak() throws RemoteException {
		// Check permission
		psv.validate(PSBatteryTemperatureEnum.ALL);
	...
	public String getLastBootCountOfCharging() throws RemoteException {
		// Check permission
		psv.validate(EnergyConstants.PS_BATTERY_CHARGING_COUNT, "true");
	...
	public String getLastBootScreenOn() throws RemoteException {
		// Check permission
		psv.validate(EnergyConstants.PS_DEVICE_SCREEN, "true");
	...
	public String getTotalBootDate() throws RemoteException {
		// Check permission
		psv.validate(PSDeviceDatesEnum.ALL);
	...
	public String uploadData() throws RemoteException {
		// Check permission
		psv.validate(EnergyConstants.PS_UPLOAD_DATA, "true");
