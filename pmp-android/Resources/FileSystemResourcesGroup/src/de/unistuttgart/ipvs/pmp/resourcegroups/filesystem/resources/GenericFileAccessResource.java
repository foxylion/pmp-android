 ...
 * Accessing protected files, such as system files, might require root-rights.
 * Otherwise this resource-group will crash. For safety and security reasons
 * it's recommended to use this resource only if special file access is needed.
 * Please use the other resources instead.
 * 
