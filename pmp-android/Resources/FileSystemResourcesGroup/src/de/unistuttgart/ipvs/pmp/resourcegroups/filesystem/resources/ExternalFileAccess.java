...
public class ExternalFileAccess extends IFileAccess.Stub {
	...
	public enum Directories {
		BASE_DIR, MUSIC, PODCASTS, RINGTONES, ALARMS, NOTIFICATIONS, PICTURES, MOVIES, DOWNLOAD
	};

	private enum Functions {
		READ, WRITE, LIST, DELETE, MAKE_DIRS
	};
	 ...
	 * 
	 * @param path
	 *            Path to the file in the external directory (e.g. /Music/
	 *            <code>path</code>)
	 * @return Data of the selected file
	 * @throws IllegalAccessError
	 *             Thrown, if app's privacy level is not set or the
	 *             <code>path</code> parameters contains character for switching
	 *             into a upper directory (typically <code>../</code>)
	 ...
	 * @param append
	 *            True, if data should be appended to the existing file data.
	 *            Otherwise it's data will be overwritten
	...
	/**
	 * Deletes a file or directory in the external directory. Directories can
	 * only be deleted if they do not have any files.
	 * 
	 * @param path
	 *            Path of the file or directory which should be deleted (e.g.
	 *            /Music/<code>path</code>)
	 ...
	 * @throws IllegalAccessError
	 *             Thrown, if the app's privacy level is not set or the
	 *             <code>path</code> parameters contains character for switching
	 *             into a upper directory (typically <code>../</code>)
	 */
	@Override
