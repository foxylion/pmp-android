...
public class Utils {
	 ...
	 * @return		Read data
	 * @throws IOException See {@link BufferedReader#read()}
	 * @throws FileNotFoundException {@link BufferedReader#BufferedReader(java.io.Reader)}
	 */
	 ...
	 * @param file	  File to which this string should be written
	 * @param data	  Data to write
	 * @param append  True, if data should be appended
	 * @throws IOException	See {@link BufferedWriter#BufferedWriter(java.io.Writer)}
	 */
	 ...
	 * @param file	Path to the base directory
