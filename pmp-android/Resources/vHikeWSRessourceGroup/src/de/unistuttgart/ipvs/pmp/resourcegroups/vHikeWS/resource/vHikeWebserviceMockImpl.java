...
public class vHikeWebserviceMockImpl extends IvHikeWebservice.Stub {
    
    public vHikeWebserviceMockImpl(vHikeWSResourceGroup vHikeRG, vHikeWebserviceResource vHikeWebserviceResource,
