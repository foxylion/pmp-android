...
public class vHikeWebserviceImpl extends IvHikeWebservice.Stub {
	...
	public vHikeWebserviceImpl(vHikeWSResourceGroup vHikeRG, vHikeWebserviceResource vHikeRes,
			String appIdentifier) {
	...
	public String register(String username, String password, String email,
		...
		return vHikeRes.register(username, password, email, firstname, lastname, tel, description,
				email_public, firstname_public, lastname_public, tel_public);
	}
	...
	public String announceTrip(String session_id, String destination,
			...
			throws RemoteException {
		this.psv.validate(vHikeWSResourceGroup.PS_USE_vHIKE_WEBSERVICE, "true");
		return vHikeRes.announceTrip(session_id, destination, current_lat, current_lon,
				avail_seats, date);
	}
