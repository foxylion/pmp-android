...
/**
 * The {@link RgAvailableAdapter} is the list of available Resource Groups in the {@link RGsAvailableTab}.
 * 
...
public class RGsAvailableAdapter extends BaseAdapter {
    ...
    public RGsAvailableAdapter(Context context, List<RgInformationSet> rgs) {
