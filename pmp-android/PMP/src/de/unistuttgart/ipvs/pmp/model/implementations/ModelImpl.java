...
public class ModelImpl implements IModel {
    ...
    public IApp[] getApps() {
        ...
        Cursor cursor = db.rawQuery("SELECT Identifier, Name_Cache, Description_Cache FROM App", null);
        ...
        Log.v("ModelImpl#getApps(): is returning " + list.size() + " datasets");
    ...
    public IApp getApp(String identifier) {
        ...
        Cursor cursor = db.rawQuery("SELECT Name_Cache, Description_Cache FROM App WHERE Identifier = ?",
        ...
        Log.v("ModelImpl#getApp(): found " + (returnValue == null ? "NO" : "a") + " app with the identifier "
                + identifier);
    ...
    public IResourceGroup[] getResourceGroups() {
        ...
        Cursor cursor = db.rawQuery("SELECT Identifier, Name_Cache, Description_Cache FROM ResourceGroup", null);
        ...
        Log.v("ModelImpl#getResourceGroups(): is returning " + list.size() + " datasets");
    ...
    public IResourceGroup getResourceGroup(String identifier) {
        ...
        Cursor cursor = db.rawQuery("SELECT Name_Cache, Description_Cache FROM ResourceGroup WHERE Identifier = ?",
                new String[] { identifier });
        ...
        Log.v("ModelImpl#getResourceGroup(): found  " + (returnValue == null ? "NO" : "a")
    ...
    public IPreset[] getPresets() {
        ...
        Cursor cursor = db.rawQuery("SELECT Name, Description, Type, Identifier FROM Preset", null);
        ...
        Log.v("ModelImpl#getPresets(): is returning " + list.size() + " datasets");
    ...
    public IPreset addPreset(String name, String description, PMPComponentType type, String identifier) {
        ...
        Log.v("ModelImpl#addPreset(): returning the " + (cursor.getCount() == 0 ? "new" : "existing") + " IPreset");
