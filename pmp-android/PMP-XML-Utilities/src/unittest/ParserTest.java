...
public class ParserTest {
    ...
    // private static final String APP_SF1_LOC_DESC =
    // "\u05d0\u05dd \u05de\u05d3\u05d5\u05d1\u05e8 \u05e2\u05dc \u05ea\u05db"
    // + "\u05d5\u05e0\u05d5\u05ea \u05d4\u05e9\u05d9\u05e8\u05d5\u05ea, \u05d6"
    // + "\u05d4 \u05dc\u05d0 \u05d9\u05db\u05d5\u05dc \u05dc\u05d4\u05d9\u05d5"
    // + "\u05ea \u05d9\u05d5\u05ea\u05e8 \u05d2\u05e8\u05d5\u05e2 \u05de\u05d6"
    ...
    //
    // AIS ais = XMLUtilityProxy.getAppUtilities().parseAISXML(
    ...
    //
    // try {
    // XMLUtilityProxy.getAppUtilities().parseAISXML(
    // XMLCompiler.compileStream(main));
    ...
    // debug(ste.getMethodName());
    //
    // RGIS rgis = XMLUtilityProxy.getRGUtilities().parseRGISXML(
    // XMLCompiler.compileStream(main));
    //
    ...
    //
    // try {
    // XMLUtilityProxy.getRGUtilities().parseRGISXML(
    // XMLCompiler.compileStream(main));
    ...
    // str.getBytes("UTF-8"));
    // try {
    // XMLUtilityProxy.getRGUtilities().parseRGISXML(bais);
    ...
    // try {
    // XMLUtilityProxy.getRGUtilities().parseRGISXML(null);
