...
/**
 * This is a representation of a resource group, which is required for a specific service level.
 * It contains the identifier of a assign privacy level and its required value.
 * 
 * @author Marcus Vetter
 *
 */
public class RequiredResourceGroup {
	...
	/**
	 * This map contains all required privacy levels of the required resource group.
	 * key = identifier of the privacy level
	 */
	 ...
	 * @param rgIdentifier of the required resource group
	 */
	 ...
	 * @param identifier of the privacy level
	 * @param requiredValue of the privacy level
	 */
