 ...
 * levels. Note that this class saves the parsing of the privacy levels. It's
 * only needed implementing feature however is the
 * {@link PrivacyLevel#parseValue(String)} function.
 * 
 * @param <T>
...
public abstract class PrivacyLevel<T> {
     ...
     */
    public abstract String getHumanReadableValue(String locale, String value)
	    throws PrivacyLevelValueException;

    /**
     * <p>
     * Should return true, if the tuple (value, reference) meets the
     * "permits more or equal" partial order. That is reference ">=" value where
     * ">=" is your defined "permits more or equal" partial order (which needs
     * not to match the classical >= partial order on numbers).
     * </p>
     * <p>
     * Note that since this is a partial order it must meet the reflexivity,
     * antisymmetry and transitivity property.
     * </p>
     * 
     * @param value
    ...
    /**
     * Convenience method for checking {@link PrivacyLevel#permits(Object, Object)} on
     ...
     */
    public boolean permits(String value, String reference)
	    throws PrivacyLevelValueException {
     ...
     * @param appIdentifier identifier of the app.
     * @param reference the reference instance of T for the check
     * @return true, if value permits more or equal to reference
     */
    ...
    /**
     * Sets the values that are stored in this {@link PrivacyLevel} for the
     * apps.
     * 
     * @param values
     *            Map from appIdentifier to actual value.
     * @throws PrivacyLevelValueException
     *             if any of the supplied values does not match the format
     *             criteria.
     */
