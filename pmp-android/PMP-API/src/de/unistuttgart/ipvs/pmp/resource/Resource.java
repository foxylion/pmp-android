...
public abstract class Resource {
     ...
     * @param appIdentifier the identifier for the accessing app
     * @param privacyLevel the name of the privacy level
     * @return the value of the privacy level
     */
    protected final String getPrivacyLevelValue(String appIdentifier, String privacyLevel) {
     ...
     * 
     * @param appIdentifier the identifier for the app accessing the interface.
     * 
