...
public class ResourceGroupApp implements Parcelable {
	 ...
	 * 
	 * @param identifier Identifier of the App
	 * @param publicKey public key of the App
	 * @param privacyLevels Bundle of privacy levels and their set values
	 */
	 ...
	 * 
	 * @param privacyLevel name of the privacy level
