package de.unistuttgart.ipvs.systemtest.stmengengeruest2;
...
import de.unistuttgart.ipvs.systemtest.stmengengeruest2.R;
import android.app.Activity;
import android.os.Bundle;
import android.os.RemoteException;
import android.widget.TextView;

public class ST_Mengengeruest_2Activity extends Activity {
	...
	Boolean sf = ((App) getApplication()).isServiceFeatureEnabled("SF" + itr);
